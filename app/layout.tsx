  ...
  return (
    <html lang="pt-BR" suppressHydrationWarning>
      <body className={`min-h-screen font-body ${fontBody.variable} ${fontHeading.variable}`}>
        <SessaoProvider>
          <header className="sticky top-0 z-40 backdrop-blur-md bg-v4bg/80 border-b border-white/[0.06] px-6 py-3.5 flex items-center justify-between flex-wrap gap-3">
            ...
            <nav className="flex items-center gap-1.5 text-sm flex-wrap">
              ...
              <a
                href="/candidatos?status=concluida"
                className="px-3.5 py-1.5 rounded-full text-white/60 hover:text-white hover:bg-white/[0.06] transition"
              >
                Entrevistas
              </a>
