...
const spec = {
  ...
  paths: {
    '/api/auth/login': { post: { tags: ['Auth'], summary: 'Login', requestBody: { required: true, content: { 'application/json': { schema: { type: 'object', required: ['email', 'senha'], properties: { email: { type: 'string' }, senha: { type: 'string' } } } } } }, responses: { '200': { description: 'OK' } } } },
    '/api/auth/logout': { post: { tags: ['Auth'], summary: 'Logout', responses: { '200': { description: 'OK' } } } },
    '/api/auth/me': { get: { tags: ['Auth'], summary: 'Usuario atual', responses: { '200': { description: 'OK' }, '401': { description: 'Nao autenticado' } } } },
    '/api/vagas': {
    ...
    '/api/candidaturas': { post: { tags: ['Candidaturas'], summary: 'Cria ou retoma candidatura', responses: { '201': { description: 'Criada' } } } },
    '/api/candidaturas/{id}': {
    ...
    '/api/candidaturas/{id}/finalizar': { post: { tags: ['Candidaturas'], summary: 'Finaliza entrevista', parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }], responses: { '200': { description: 'OK' } } } },
    '/api/candidaturas/{id}/curriculo': { post: { tags: ['Candidaturas'], summary: 'Upload curriculo PDF', parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }], responses: { '201': { description: 'OK' } } } },
    '/api/candidaturas/{id}/parecer': { get: { tags: ['Candidaturas'], summary: 'Gera parecer IA (+ ?formato=pdf)', parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }], responses: { '200': { description: 'OK' } } } },
    '/api/candidaturas/{id}/notas': { post: { tags: ['Candidaturas'], summary: 'Adiciona nota interna', security: [{ SessionAuth: [] }], parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }], responses: { '201': { description: 'OK' } } } },
    '/api/candidaturas/{id}/fase': { patch: { tags: ['Candidaturas'], summary: 'Move candidato de fase', security: [{ SessionAuth: [] }], parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }], responses: { '200': { description: 'OK' } } } },
    '/api/candidatos': { get: { tags: ['Candidatos'], summary: 'Kanban global com filtros', responses: { '200': { description: 'OK' } } } },
    '/api/dashboard': { get: { tags: ['Dashboard'], summary: 'Metricas real-time', responses: { '200': { description: 'OK' } } } },
    '/api/relatorios': { get: { tags: ['Relatorios'], summary: 'Analise profunda com filtros', responses: { '200': { description: 'OK' } } } },
    '/api/tts': { post: { tags: ['TTS'], summary: 'Gera audio via Gemini TTS', responses: { '200': { description: 'OK' } } } },
    '/api/usuarios': {
    ...
    '/api/usuarios/{id}': { delete: { tags: ['Usuarios'], summary: 'Remove usuario (admin)', security: [{ SessionAuth: [] }], parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }], responses: { '200': { description: 'OK' } } } },
    '/api/logs': { get: { tags: ['Logs'], summary: 'Auditoria (admin)', security: [{ SessionAuth: [] }], responses: { '200': { description: 'OK' } } } },
    '/api/integracoes/vagas': { get: { tags: ['Integracoes'], summary: 'Lista vagas (externo)', security: [{ ApiKeyAuth: [] }], responses: { '200': { description: 'OK' } } }, post: { tags: ['Integracoes'], summary: 'Cria vaga (externo)', security: [{ ApiKeyAuth: [] }], responses: { '201': { description: 'OK' } } } },
    '/api/integracoes/vagas/{id}': { get: { tags: ['Integracoes'], summary: 'Detalhe vaga (externo)', security: [{ ApiKeyAuth: [] }], parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }], responses: { '200': { description: 'OK' } } } },
    '/api/integracoes/candidaturas': { get: { tags: ['Integracoes'], summary: 'Lista candidaturas (externo)', security: [{ ApiKeyAuth: [] }], responses: { '200': { description: 'OK' } } } },
    '/api/integracoes/candidaturas/{id}': { get: { tags: ['Integracoes'], summary: 'Detalhe candidatura (externo)', security: [{ ApiKeyAuth: [] }], parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }], responses: { '200': { description: 'OK' } } } },
    '/api/integracoes/export': { get: { tags: ['Integracoes'], summary: 'Export completo (externo)', security: [{ ApiKeyAuth: [] }], responses: { '200': { description: 'OK' } } } }
  }
};
