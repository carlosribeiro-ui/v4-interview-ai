...
const spec = {
  ...
  paths: {
    ...
    '/api/candidaturas/{id}/parecer': { get: { tags: ['Candidaturas'], summary: 'Gera parecer IA (+ ?formato=csv|pdf)', parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }], responses: { '200': { description: 'OK' } } } },
    ...
    '/api/logs': { get: { tags: ['Logs'], summary: 'Auditoria (admin) (+ ?formato=csv|pdf)', security: [{ SessionAuth: [] }], responses: { '200': { description: 'OK' } } } },
